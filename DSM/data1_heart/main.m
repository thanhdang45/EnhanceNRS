...
tic;
T_para=zeros(1,6,4);
T_para(1,1:3,:)=make_increasing_matrix(3,4);
T_para(1,4:6,:)=make_increasing_matrix(3,4);

I_para=zeros(1,6,4);
I_para(1,1:3,:)=make_increasing_matrix(3,4);
I_para(1,4:6,:)=make_increasing_matrix(3,4);

F_para=zeros(1,6,4);
F_para(1,1:3,:) = make_increasing_matrix(3,4);
F_para(1,4:6,:) = make_increasing_matrix(3,4);
